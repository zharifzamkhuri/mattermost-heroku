...
export TIME_BETWEEN_USER_TYPING_UPDATES_MILLISECONDS=`echo ${TIME_BETWEEN_USER_TYPING_UPDATES_MILLISECONDS:=5000} | tr -d \"`export TIME_BETWEEN_USER_TYPING_UPDATES_MILLISECONDS=`echo ${TIME_BETWEEN_USER_TYPING_UPDATES_MILLISECONDS:=5000} | tr -d \"`
export ENABLE_USER_TYPING_MESSAGES=`echo ${ENABLE_USER_TYPING_MESSAGES:=true} | tr -d \"`
export ENABLE_LINK_PREVIEWS=`echo ${ENABLE_LINK_PREVIEWS:=false} | tr -d \"`
export RESTRICT_POST_DELETE=`echo ${RESTRICT_POST_DELETE:=all} | tr -d \"`
export ALLOW_EDIT_POST=`echo ${ALLOW_EDIT_POST:=always} | tr -d \"`
export POST_EDIT_TIME_LIMIT=`echo ${POST_EDIT_TIME_LIMIT:=300} | tr -d \"`
export CLUSTER_LOG_TIMEOUT_MILLISECONDS=`echo ${CLUSTER_LOG_TIMEOUT_MILLISECONDS:=2000} | tr -d \"`
...
export MAX_NOTIFICATIONS_PER_CHANNEL=`echo ${MAX_NOTIFICATIONS_PER_CHANNEL:=1000} | tr -d \"`
export RESTRICT_PRIVATE_CHANNEL_MANAGE_MEMBERS=`echo ${RESTRICT_PRIVATE_CHANNEL_MANAGE_MEMBERS:="all"}`
...
export SKIP_SERVER_CERTIFICATE_VERIFICATION=`echo ${SKIP_SERVER_CERTIFICATE_VERIFICATION:=false} | tr -d \"`
